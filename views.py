...
@login_required
@htmx_view('maintenance/pages/maintenance_order_add.html', 'maintenance/partials/maintenance_order_add_content.html')
def maintenance_order_add(request):
    ...
    if request.method == 'POST':
        ...
        response['HX-Redirect'] = reverse('maintenance:maintenance_orders_list')
        return response
    return {}

@login_required
@htmx_view('maintenance/pages/maintenance_order_edit.html', 'maintenance/partials/maintenance_order_edit_content.html')
