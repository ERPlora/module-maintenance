    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenance_type', models.CharField(choices=[('preventive', 'Preventive'), ('corrective', 'Corrective'), ('predictive', 'Predictive')], default='corrective', max_length=20, verbose_name='Maintenance Type')),
